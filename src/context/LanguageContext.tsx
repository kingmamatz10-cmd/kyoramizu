...
export const translations = {
  EN: {
      ...
      timeline: [
        {
          ...
          image: "/images/kyoramizu_kemasan_2017_before.png",
        },
        {
          year: "2018 – 2019",
          ...
          image: "/images/kyoramizu_kemasan_2018_2019_after.png",
        },
      ],
    },
    ingredients: {
    ...
    products: {
      ...
      orderNow: "Order Now",
      chatPricing: "Chat For Pricing Info",
      ...
      items: [
        {
          ...
          price: "IDR 15,000",
          volume: "230ml glass bottle",
          description: "Fixed price for retail purchase per bottle, delivered straight to your door.",
        ...
        },
        {
          ...
          subtitle: "Classic Crimson Elixir",
          price: "Special Price For Resellers",
          volume: "",
          description: "Get attractive margins for resale. Pricing and minimum order details will be shared directly when you chat with our team.",
          desc: "The timeless signature blend. Bold red ginger heat harmonized with ruby Sappan wood, sweet cinnamon, and smooth palm nectar.",
        ...
        },
        {
          ...
          subtitle: "Classic Crimson Elixir",
          price: "Special Price For Partners",
          volume: "",
          description: "For hotel, restaurant, cafe, or corporate partnerships. Pricing adjusts to your volume needs — chat with us for a custom offer.",
          desc: "The timeless signature blend. Bold red ginger heat harmonized with ruby Sappan wood, sweet cinnamon, and smooth palm nectar.",
  ...
  ID: {
    ...
    products: {
      ...
      chatPricing: "Chat Untuk Info Harga",
      ...
      items: [
        {
          id: "royal-original",
          name: "Pembelian Satuan",
          subtitle: "Elikser Merah Klasik",
          price: "Rp 15.000",
          volume: "Botol Kaca 230ml",
          description: "Harga tetap untuk pembelian eceran per botol, langsung kirim ke alamat kamu.",
        ...
        },
        {
          ...
          subtitle: "Elikser Merah Klasik",
          price: "Harga Khusus Untuk Para Reseller",
          volume: "",
          description: "Dapatkan margin menarik untuk dijual kembali. Info harga & minimum order akan dijelaskan langsung saat kamu chat dengan tim kami.",
          desc: "Varian signature klasik. Kehangatan jahe merah dipadukan dengan kayu secang crimson, kayu manis, dan gula aren murni.",
        ...
        },
        {
          ...
          subtitle: "Elikser Merah Klasik",
          price: "Harga Special Untuk Para Mitra",
          volume: "",
          description: "Untuk kerja sama hotel, resto, kafe, atau korporat. Skema harga menyesuaikan volume kebutuhan — chat kami untuk penawaran khusus.",
          desc: "Varian signature klasik. Kehangatan jahe merah dipadukan dengan kayu secang crimson, kayu manis, dan gula aren murni.",
