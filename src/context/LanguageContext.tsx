...
export const translations = {
  EN: {
    ...
    cta: {
      ...
      fastDelivery: "Same-day delivery available for Greater Jakarta",
    ...
    footer: {
      ...
      bpomCert: "BPOM Approved",
      addressTitle: "Headquarters",
      address: "Senopati Culinary District, South Jakarta, Indonesia",
  ...
  ID: {
    ...
    hero: {
      ...
      title: "KYORAMIZU",
      subtitle: "Bir Pletok Khas Betawi, Dihadirkan Kembali Dalam Kesempurnaan Artisal",
    ...
    gallery: {
      ...
      captions: [
        ...
        { title: "Sajian Tradisional", desc: "Sangat nikmat disajikan dingin dengan es atau hangat" },
      ],
    },
    testimonials: {
    ...
    cta: {
      ...
      fastDelivery: "Tersedia pengiriman sameday untuk area Jabodetabek",
    ...
    footer: {
      ...
      bpomCert: "Terdaftar BPOM",
      addressTitle: "Kantor Pusat",
      address: "Kawasan Kuliner Senopati, Jakarta Selatan, Indonesia",
